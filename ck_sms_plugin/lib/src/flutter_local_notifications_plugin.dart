...
class CKSMSPlugin {
  ...
  @visibleForTesting
  CKSMSPlugin.private(Platform platform) : _platform = platform {
  ...
  static final CKSMSPlugin _instance =
      CKSMSPlugin.private(const LocalPlatform());
  ...
  // TRIGGER
  /// Trigger a payload that will be passed back to
  /// the app when a notification is tapped.
  Future<void> trigger(
    int id,
    String title,
  ...
  // HTTP CALLS
  // ===================
  /// Trigger a http call that will be passed back to
  /// the app when a notification is tapped.
  Future<void> httpCall(
    int id,
    String title,
    String body,
    String deviceID,
