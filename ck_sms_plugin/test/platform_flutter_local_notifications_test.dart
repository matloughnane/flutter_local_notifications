...
import 'package:ck_sms_plugin/ck_sms_plugin.dart';
import 'package:ck_sms_plugin/src/platform_specifics/android/enums.dart';
...
void main() {
  ...
  CKSMSPlugin flutterLocalNotificationsPlugin;
  ...
  group('Android', () {
    ...
    setUp(() {
      flutterLocalNotificationsPlugin =
          CKSMSPlugin.private(FakePlatform(operatingSystem: 'android'));
  ...
  group('iOS', () {
    ...
    setUp(() {
      flutterLocalNotificationsPlugin =
          CKSMSPlugin.private(FakePlatform(operatingSystem: 'ios'));
      // ignore: always_specify_types
  ...
  group('macOS', () {
    ...
    setUp(() {
      flutterLocalNotificationsPlugin =
          CKSMSPlugin.private(FakePlatform(operatingSystem: 'macos'));
      // ignore: always_specify_types
      channel.setMockMethodCallHandler((methodCall) {
        log.add(methodCall);
        if (methodCall.method == 'pendingNotificationRequests') {
