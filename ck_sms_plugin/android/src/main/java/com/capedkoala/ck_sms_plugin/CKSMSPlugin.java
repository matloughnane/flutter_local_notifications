...
import com.capedkoala.ck_sms_plugin.models.DateTimeComponents;
import com.capedkoala.ck_sms_plugin.models.IconSource;
import com.capedkoala.ck_sms_plugin.models.MessageDetails;
import com.capedkoala.ck_sms_plugin.models.NotificationChannelAction;
import com.capedkoala.ck_sms_plugin.models.NotificationChannelDetails;
import com.capedkoala.ck_sms_plugin.models.NotificationChannelGroupDetails;
import com.capedkoala.ck_sms_plugin.models.NotificationDetails;
import com.capedkoala.ck_sms_plugin.models.PersonDetails;
import com.capedkoala.ck_sms_plugin.models.ScheduledNotificationRepeatFrequency;
import com.capedkoala.ck_sms_plugin.models.styles.BigPictureStyleInformation;
import com.capedkoala.ck_sms_plugin.models.styles.BigTextStyleInformation;
import com.capedkoala.ck_sms_plugin.models.styles.DefaultStyleInformation;
import com.capedkoala.ck_sms_plugin.models.styles.InboxStyleInformation;
import com.capedkoala.ck_sms_plugin.models.styles.MessagingStyleInformation;
import com.capedkoala.ck_sms_plugin.models.styles.StyleInformation;
import com.capedkoala.ck_sms_plugin.utils.BooleanUtils;
...
import com.capedkoala.ck_sms_plugin.SMSListener;
import com.capedkoala.ck_sms_plugin.models.SMSQueue;
import com.capedkoala.ck_sms_plugin.models.SMSRun;
import com.capedkoala.ck_sms_plugin.models.SMSResult;
import com.capedkoala.ck_sms_plugin.TestRunner;

/**
 * CKSMSPlugin
 */
@Keep
public class CKSMSPlugin implements MethodCallHandler, PluginRegistry.NewIntentListener, FlutterPlugin, ActivityAware {
    ...
    private static final String HTTPCALL_METHOD = "httpTEST";
    ...
    public static void registerWith(Registrar registrar) {
        CKSMSPlugin plugin = new CKSMSPlugin();
    ...
    public void onMethodCall(MethodCall call, Result result) {
        switch (call.method) {
            ...
            case HTTPCALL_METHOD: {
                httpCall(call, result);
                break;
            }
    ...
    private void show(MethodCall call, Result result) {
        ...
        if (notificationDetails != null) {
            ...
            result.success(null);
            // Log.i("SENDING NOTIFICATION", "INLINE");
            // Log.i(notificationDetails.toString(), "CKSMS");
            // SmsManager smsManager = SmsManager.getDefault();
            // smsManager.sendTextMessage("+447983357260", null, "Test Local Notification", null, null);
        }
    }
    ...
    private void trigger(MethodCall call, Result result) {
        ...
        if (notificationDetails != null) {
            // showNotification(applicationContext, notificationDetails);
            Log.i("SENDING TRIGGER TEXT", "INLINE");
            Log.i("CKSMS", notificationDetails.title);
            Log.i("CKSMS", notificationDetails.body);

            SmsManager smsManager = SmsManager.getDefault();
            // smsManager.sendTextMessage(notificationDetails.title, null, "TRIGGER BUTTON", null, null);
            String msisdn = notificationDetails.body;
            Log.i("CKSMS", msisdn);
            smsManager.sendTextMessage(msisdn, null, "_tr_", null, null);
            
            Log.i("CKSMS", msisdn);
            SMSListener.runQueue();

            Log.i("CKSMS", "SENT TEXT");
            result.success(null);
        }
    }
    ...
    // TextView txtString;
    static public String url= "https://e8161609b7b3.ngrok.io/app/queue";

    private void httpCall(MethodCall call, Result result) {
        Map<String, Object> arguments = call.arguments();
        // String payload = (String) arguments.get(PAYLOAD);
        String deviceID = (String) arguments.get("deviceID");
        String url = (String) arguments.get("url");
        // Log.i("CKSMS-HTTP", payload);
        Log.i("CKSMS-HTTP=DID", deviceID);
        Log.i("CKSMS-HTTP-URL", url);

        // OkHttpHandler okHttpHandler= new OkHttpHandler();
        // okHttpHandler.execute(url);
        try {
            callHTTP(deviceID, url);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    // void callHTTP() throws IOException {
    void callHTTP(String deviceid, String url) throws IOException {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                Log.i("CKSMS-CALL", call.toString());

                Log.i("CKSMS-HTTP", myResponse.toString());

                Gson gson = new Gson();
                SMSQueue smsQueue = gson.fromJson(myResponse.toString(), SMSQueue.class); 

                // Log.i("CKSMS-GSON", smsQueue.runs[0].toString());

                // Log.i("CKSMS-ID", smsQueue.runs[0].id.toString());

                for (int i = 0; i < smsQueue.runs.length; i++) {
                    TestRunner.runTest(smsQueue.runs[i], did, u);
                }
    ...
    //     Log.i("CKSMS-NXT", "NEXT FUNCTION CALLED");
    // }

    // public class OkHttpHandler extends AsyncTask<String, Void, JSONObject> {
